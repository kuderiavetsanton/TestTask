...
const PostModify: React.FC<Props> = ({ bodyInit, titleInit, dispatchAction,modifyName }) => {
        ...
        <>
            <PostForm onSubmit={handleSubmit}>
                <FormControl>
                    ...
                    <FormInput full type="text" value={ title} onChange={e => setTitle(e.target.value)} id="title"/>
                </FormControl>
                <FormControl>
                    <label htmlFor="body">Body:</label>
                    <FormTextarea value={ body } onChange={e => setBody(e.target.value)} id="body"/>
                </FormControl>
